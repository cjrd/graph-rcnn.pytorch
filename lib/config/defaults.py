...
# Use freq bias
_C.MODEL.ROI_RELATION_HEAD.USE_GT_BOXES = False
# Dilation
...
_C.TEST.SAVE_INTERMEDIATE_FEATURES = False
_C.TEST.INTERMEDIATE_FEATURES_FILE = "/scratch/cjrd/intermediate-sgfeats.h5"
_C.TEST.INTERMEDIATE_FEATURES_TOPK_RELS = 30
_C.TEST.INTERMEDIATE_FEATURES_FEAT_SIZE = 1024
